...
Route::group([
    ...
    Route::crud('part-template/{taggable_id}/tags', 'TagCrudController');
    ...
    Route::crud('part/{taggable_id}/tags', 'TagCrudController');
    ...
    Route::crud('part-item/{taggable_id}/tags', 'TagCrudController');
    Route::crud('part-batch', 'PartBatchCrudController');
    Route::crud('equipment', 'EquipmentCrudController');
    Route::crud('equipment/{taggable_id}/tags', 'TagCrudController');
    ...
    Route::crud('storage-location/{taggable_id}/tags', 'TagCrudController');
