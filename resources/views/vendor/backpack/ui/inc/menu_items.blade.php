@php
    use App\Enum\PermissionsEnum;use Illuminate\Support\Str;
@endphp
...
@can(PermissionsEnum::PARTS->value)
    <x-backpack::menu-dropdown title="Запчасти" icon="la la-wrench">
        ...
        <x-backpack::menu-dropdown-item title="Партии запчастей" icon="la la-wrench"
                                        :link="backpack_url('part-batch')"/>
    </x-backpack::menu-dropdown>
@endcan
@can(PermissionsEnum::STORAGE->value)
...
@endcan
@can(PermissionsEnum::AUTHORIZATION->value)
    <x-backpack::menu-dropdown title="Авторизация" icon="la la-lock">
        ...
        <x-backpack::menu-dropdown-item
                title="{{ Str::ucfirst(trans('backpack::permissionmanager.permission_plural')) }}"
                icon="la la-key" :link="backpack_url('permission')"/>
    </x-backpack::menu-dropdown>
@endcan
@can(PermissionsEnum::REPORTS->value)
    <x-backpack::menu-item title="Отчеты" icon="la la-book" :link="backpack_url('report')"/>
@endcan
@can(PermissionsEnum::SETTINGS->value)
